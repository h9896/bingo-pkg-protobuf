...
var file_services_delivery_v1_trade_msg_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x42, 0x40, 0x5a, 0x3e, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x68, 0x39, 0x38, 0x39, 0x36, 0x2f, 0x62,
	0x69, 0x6e, 0x67, 0x6f, 0x2d, 0x70, 0x6b, 0x67, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x64, 0x65,
	0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x2f, 0x76, 0x31, 0x3b, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_services_delivery_v1_trade_msg_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_services_delivery_v1_trade_msg_proto_goTypes = []interface{}{
	...
	(OrderSide)(0),                               // 22: services.delivery.v1.OrderSide
	(PositionSide)(0),                            // 23: services.delivery.v1.PositionSide
	(OrderType)(0),                               // 24: services.delivery.v1.OrderType
	(WorkingType)(0),                             // 25: services.delivery.v1.WorkingType
	(ResponseType)(0),                            // 26: services.delivery.v1.ResponseType
	(TimeInForce)(0),                             // 27: services.delivery.v1.TimeInForce
	(OrderStatus)(0),                             // 28: services.delivery.v1.OrderStatus
	(*BatchOrders)(nil),                          // 29: services.delivery.v1.BatchOrders
	(*ModifyBatchOrders)(nil),                    // 30: services.delivery.v1.ModifyBatchOrders
	(MarginType)(0),                              // 31: services.delivery.v1.MarginType
}
var file_services_delivery_v1_trade_msg_proto_depIdxs = []int32{
	22, // 0: services.delivery.v1.NewOrderRequest.side:type_name -> services.delivery.v1.OrderSide
	23, // 1: services.delivery.v1.NewOrderRequest.positionSide:type_name -> services.delivery.v1.PositionSide
	24, // 2: services.delivery.v1.NewOrderRequest.type:type_name -> services.delivery.v1.OrderType
	25, // 3: services.delivery.v1.NewOrderRequest.workingType:type_name -> services.delivery.v1.WorkingType
	26, // 4: services.delivery.v1.NewOrderRequest.newOrderRespType:type_name -> services.delivery.v1.ResponseType
	27, // 5: services.delivery.v1.NewOrderRequest.timeInForce:type_name -> services.delivery.v1.TimeInForce
	22, // 6: services.delivery.v1.NewOrderResponse.side:type_name -> services.delivery.v1.OrderSide
	23, // 7: services.delivery.v1.NewOrderResponse.positionSide:type_name -> services.delivery.v1.PositionSide
	28, // 8: services.delivery.v1.NewOrderResponse.status:type_name -> services.delivery.v1.OrderStatus
	27, // 9: services.delivery.v1.NewOrderResponse.timeInForce:type_name -> services.delivery.v1.TimeInForce
	24, // 10: services.delivery.v1.NewOrderResponse.type:type_name -> services.delivery.v1.OrderType
	24, // 11: services.delivery.v1.NewOrderResponse.origType:type_name -> services.delivery.v1.OrderType
	25, // 12: services.delivery.v1.NewOrderResponse.workingType:type_name -> services.delivery.v1.WorkingType
	24, // 13: services.delivery.v1.CancelOrderResponse.origType:type_name -> services.delivery.v1.OrderType
	22, // 14: services.delivery.v1.CancelOrderResponse.side:type_name -> services.delivery.v1.OrderSide
	23, // 15: services.delivery.v1.CancelOrderResponse.positionSide:type_name -> services.delivery.v1.PositionSide
	28, // 16: services.delivery.v1.CancelOrderResponse.status:type_name -> services.delivery.v1.OrderStatus
	27, // 17: services.delivery.v1.CancelOrderResponse.timeInForce:type_name -> services.delivery.v1.TimeInForce
	24, // 18: services.delivery.v1.CancelOrderResponse.type:type_name -> services.delivery.v1.OrderType
	25, // 19: services.delivery.v1.CancelOrderResponse.workingType:type_name -> services.delivery.v1.WorkingType
	22, // 20: services.delivery.v1.ModifyOrderRequest.side:type_name -> services.delivery.v1.OrderSide
	22, // 21: services.delivery.v1.ModifyOrderResponse.side:type_name -> services.delivery.v1.OrderSide
	28, // 22: services.delivery.v1.ModifyOrderResponse.status:type_name -> services.delivery.v1.OrderStatus
	27, // 23: services.delivery.v1.ModifyOrderResponse.timeInForce:type_name -> services.delivery.v1.TimeInForce
	24, // 24: services.delivery.v1.ModifyOrderResponse.type:type_name -> services.delivery.v1.OrderType
	23, // 25: services.delivery.v1.ModifyOrderResponse.positionSide:type_name -> services.delivery.v1.PositionSide
	25, // 26: services.delivery.v1.ModifyOrderResponse.workingType:type_name -> services.delivery.v1.WorkingType
	24, // 27: services.delivery.v1.ModifyOrderResponse.origType:type_name -> services.delivery.v1.OrderType
	29, // 28: services.delivery.v1.PlaceMultipleOrdersRequest.batchOrders:type_name -> services.delivery.v1.BatchOrders
	3,  // 29: services.delivery.v1.PlaceMultipleOrdersResponse.batchOrders:type_name -> services.delivery.v1.NewOrderResponse
	30, // 30: services.delivery.v1.ModifyMultipleOrdersRequest.batchOrders:type_name -> services.delivery.v1.ModifyBatchOrders
	...
	23, // 33: services.delivery.v1.ModifyIsolatedPositionMarginRequest.positionSide:type_name -> services.delivery.v1.PositionSide
